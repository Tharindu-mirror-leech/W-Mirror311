...
class _BotCommands:
    def __init__(self):
        ...
        self.CancelAllCommand = getCommand('CANCEL_ALL_COMMAND', f'cancelall{CMD_INDEX}', f'cl{CMD_INDEX}')
        self.ListCommand = getCommand('LIST_COMMAND', f'list{CMD_INDEX}', f'ls{CMD_INDEX}')
        self.SearchCommand = getCommand('SEARCH_COMMAND', f'search{CMD_INDEX}', f's{CMD_INDEX}')
        ...
        self.PingCommand = getCommand('PING_COMMAND', f'ping{CMD_INDEX}', f'p{CMD_INDEX}')
        ...
        self.BtSelectCommand = getCommand('BTSEL_COMMAND', f'push{CMD_INDEX}')
        ...
        self.WatchCommand =  getCommand('WATCH_COMMAND', f'watch{CMD_INDEX}', f'y{CMD_INDEX}')
        self.ZipWatchCommand = getCommand('ZIPWATCH_COMMAND', f'zipwatch{CMD_INDEX}', f'yz{CMD_INDEX}')
        ...
        self.LeechWatchCommand = getCommand('LEECHWATCH_COMMAND',  f'leechwatch{CMD_INDEX}', f'yl{CMD_INDEX}')
        ...
        self.LeechZipWatchCommand = getCommand('LEECHZIPWATCH_COMMAND', f'leechzipwatch{CMD_INDEX}', f'uzl{CMD_INDEX}')
